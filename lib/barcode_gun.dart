...
class BarcodeGun extends StatefulWidget {
  const BarcodeGun({super.key});

  @override
  State<BarcodeGun> createState() => _BarcodeGunState();
}

class _BarcodeGunState extends State<BarcodeGun> {
  @override
